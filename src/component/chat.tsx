...
export function Chat({ contact }) {
    ...
    return (
        <section className="chat m-2">
            ...
            <br />
            <button
                className="text-xs bg-gray-400 rounded px-2 py-1 m-2 text-blue-800">Kirim ke {contact.email}</button>
        </section>
    )
}
    ...
    return (
        <div>
            <table className="w-1/2 text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 darl:bg-gray-700 dark:text-gray-400">
                    <tr>
